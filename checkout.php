...
<body>
        ...
        function displayProductDetails() {
            checkoutItems.forEach((item, index) => {
                ...
                productDiv.innerHTML = `
                    ...
                    <input type="text" id="productName${index}" name="productName[]" value="${item.name}" readonly>
                    
                    <label for="productSize${index}">Product Size:</label>
                    <input type="text" id="productSize${index}" name="productSize[]" value="${item.size}" readonly>

                    <label for="productQuantity${index}">Quantity:</label>
                    <input type="text" id="productQuantity${index}" name="productQuantity[]" value="${item.quantity}" readonly>
                `;
    ...
    // Clear the cart from localStorage after form submission
    localStorage.removeItem("cart");
    
    // Optionally, clear sessionStorage if you want to reset it after checkout
    sessionStorage.removeItem("checkoutItems");
    window.onbeforeunload = function() {
            sessionStorage.removeItem('checkoutProduct'); // Clear product details from sessionStorage
        };
